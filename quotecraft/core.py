"""QUOTECRAFT core — Proposal / quote / SOW generator — YAML to branded PDF."""
...
RULES = [
    ("QUO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("QUO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("QUO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
