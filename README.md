...
[![PyPI](https://img.shields.io/pypi/v/cognis-quotecraft.svg)](https://pypi.org/project/cognis-quotecraft/)
[![CI](https://github.com/cognis-digital/quotecraft/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/quotecraft/actions)
...
QUOTECRAFT exists for one job — proposal / quote / sow generator — yaml to branded pdf — and does it without a SaaS bill or heavyweight setup.
...
```bash
quotecraft --version
quotecraft scan .                      # scan the current project
quotecraft scan . --format json
quotecraft scan . --fail-on high       # non-zero exit for CI gates
quotecraft mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **PandaDoc**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`quotecraft` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
