#!/usr/bin/env sh
# Universal installer for quotecraft. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/quotecraft.git"
echo "Installing quotecraft ..."
